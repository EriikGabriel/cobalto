...
export default function Home() {
  return (
    <main className="max-w-dvw h-dvh flex flex-col items-center gap-2 px-60">
      <header className="flex justify-center items-center gap-3 animate-fade-in opacity-0 z-10 min-h-20 w-full mb-20">
      ...
      <div className="relative mt-20 animate-fade-up opacity-0 [--animation-delay:400ms] [perspective:2000px] after:absolute after:inset-0 after:z-50 after:[background:linear-gradient(to_top,hsl(var(--background))_30%,transparent)]">
        <div
