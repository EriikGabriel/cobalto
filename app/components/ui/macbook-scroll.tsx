...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="relative min-h-[165vh] flex flex-col items-center pt-32 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
